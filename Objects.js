 ...
 * @type {{make: vector.make, dot: vector.dot, scale: vector.scale, add: vector.add, sub: vector.sub, modv: vector.modv, max_val: vector.max_val, normalise: vector.normalise}}
 */
var vector = {
    make: function (x, y, z) {
        return [x, y, z];
